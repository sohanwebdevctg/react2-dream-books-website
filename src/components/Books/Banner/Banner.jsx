        ...
        <div className="sm:flex sm:justify-between sm:items-center gap-4">
          ...
          <div className="sm:flex-1">
            ...
            <div className="mt-2 lg:mt-3">
              <button className="bg-yellow-600 text-whit text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs xl:text-base 2xl:text-lg py-1 px-3 lg:py-2 lg:px-4 xl:py-2 xl:px-5 2xl:py-2 2xl:px-6 text-white">
                Shop Now
              </button>
            </div>
          </div>
