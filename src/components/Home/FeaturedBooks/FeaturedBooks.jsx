    ...
    <div className="my-10">
      <div className="container mx-auto px-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-5 gap-2 sm:gap-3 md:gap-2 lg:gap-4 xl:gap-4 2xl:gap-5 mt-10">
          {
            books.map((book) => <div key={book.id} className="border-[1px] border-solid border-gray-500 hover:border-blue-500 duration-300 mx-auto p-2 sm:p-2 md:p-2 lg:p-3 xl:p-4 2xl:p-5">
              {/* image section start */}
